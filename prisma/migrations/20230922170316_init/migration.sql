...
CREATE TABLE "prices" (
    ...
    "currency" TEXT,
    "pricing_type" "PricingType" NOT NULL DEFAULT 'recurring',
...
-- AddForeignKey
ALTER TABLE "subscriptions" ADD CONSTRAINT "subscriptions_price_id_fkey" FOREIGN KEY ("price_id") REFERENCES "prices"("id") ON DELETE CASCADE ON UPDATE CASCADE;
